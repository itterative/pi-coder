...
import { FrontmatterParseError, parseFrontmatter } from "../../src/common/frontmatter";
...
describe("parseFrontmatter", () => {
    ...
    it("requires the YAML value to be a mapping", () => {
        expect(() => parseFrontmatter("---\n- one\n- two\n---\n", "broken.md")).toThrow(
            new FrontmatterParseError("broken.md", "frontmatter must contain a YAML mapping"),
        );
    });
});
