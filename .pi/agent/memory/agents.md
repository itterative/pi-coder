...
- `/agents` browses current/past child sessions and isolated workspaces. Durable restoration is limited to the exact parent session and active tree branch; interrupted runs never restart or replay automatically.
