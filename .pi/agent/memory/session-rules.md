...
- The remembered action is resolved when the prompt is confirmed. The session prompt mode resets to sandbox on session start; `s` toggles sandbox/direct mode, while configured rules and heuristic grants retain their own actions.
