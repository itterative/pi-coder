...
export function registerAgentTool(pi: ExtensionAPI, executeAction: AgentToolExecutor): void {
    pi.registerTool({
        ...
        description:
            ...
            + "parent sessions, paused and interrupted child context survives reload, restart, and switching away and back. The parent can inspect, apply, discard, or revise isolated workspace results, and revise collected terminal non-mutating runs without a workspace, without opening the TUI. "
        ...
        promptGuidelines: [
            ...
            "After collecting a terminal read-only or command-capable run, use action=\"revise\" with its runId and guidance to continue the existing child session without an isolated workspace.",
