...
export const SLUG_ADJECTIVES = [
    "amber", "ancient", "bright", "calm", "cobalt", "copper", "crimson", "distant",
    "gentle", "golden", "hidden", "hushed", "indigo", "kind", "lucid", "misty",
    "quiet", "rapid", "restful", "silver", "soft", "steady", "sunlit", "swift",
    "violet", "warm", "wandering", "white", "wild", "zealous",
] as const;

export const SLUG_NOUNS = [
    "anchor", "brook", "canyon", "comet", "falcon", "garden", "harbor", "island",
    "lantern", "meadow", "orbit", "pine", "quartz", "raven", "river", "summit",
    "thicket", "trail", "valley", "willow", "beacon", "cliff", "grove", "horizon",
    "kestrel", "maple", "northstar", "pebble", "rainfall", "shore", "stone", "tide",
] as const;
